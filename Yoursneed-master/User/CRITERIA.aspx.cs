...
public partial class User_CRITERIA : System.Web.UI.Page
{
    ...
    public void bindgrid()
    {
        ...
        dtg = objsql.GetTable("select l.regno,l.leftdirect,l.rightdirect,l.leftleg,l.rightleg,u.fname from legs l Inner Join usersnew u on l.regno=u.regno and l.regno='" + Session["user"].ToString() + "'");
        if(dtg.Rows.Count>0)
        {
